...
import { AppError, ERR_DEFS, FriendshipFullDTO } from '@transcendence/core';
...
describe('Friends Controller tests', () => {
  ...
  //     vi.spyOn(friendshipService, 'getFriendsByUserId').mockResolvedValue([mockFriendshipDTO] as any);
