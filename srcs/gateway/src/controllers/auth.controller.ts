...
export async function authRootHandler(this: FastifyInstance, request: FastifyRequest, reply: FastifyReply) {
  return proxyRequest(this, request, reply, `${AUTH_SERVICE_URL}/`);
}

export async function authHealthHandler(this: FastifyInstance, request: FastifyRequest, reply: FastifyReply) {
