...
const insertSnapTournamentStmt = db.prepare(`INSERT INTO snapshot(tx_id,tour_id,player1_id,player2_id,player3_id,player4_id) VALUES (?,?,?,?,?,?)`);
...
export function insertSnapTournament(block: BlockTournamentInput): number{
    try {    
        const idb = insertSnapTournamentStmt.run(block.tx_id, block.tour_id, block.player1_id, block.player2_id, block.player3_id, block.player4_id);
