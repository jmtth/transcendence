(() => {
  ...
  var HealthChecker = class {
    ...
    async checkNginx() {
      ...
      const nginxLabel =
        (_a = nginxDot == null ? void 0 : nginxDot.nextElementSibling) == null
          ? void 0
    ...
    async checkUsers() {
      ...
      const usersLabel =
        (_a = usersDot == null ? void 0 : usersDot.nextElementSibling) == null
          ? void 0
          : _a.nextElementSibling;
      try {
    ...
    async checkRedis() {
      ...
      const redisLabel =
        (_a = redisDot == null ? void 0 : redisDot.nextElementSibling) == null
          ? void 0
          : _a.nextElementSibling;
      try {
    ...
    async checkAPI() {
      ...
      const apiLabel =
        (_a = apiDot == null ? void 0 : apiDot.nextElementSibling) == null
          ? void 0
          : _a.nextElementSibling;
      try {
    ...
    async checkGame() {
      ...
      const gameLabel =
        (_a = gameDot == null ? void 0 : gameDot.nextElementSibling) == null
          ? void 0
          : _a.nextElementSibling;
      try {
    ...
    async checkBlockchain() {
      ...
      const blockLabel =
        (_a = blockDot == null ? void 0 : blockDot.nextElementSibling) == null
          ? void 0
          : _a.nextElementSibling;
      try {
  ...
  var GameDisplay = class {
    ...
    display() {
      ...
      try {
        ...
        (_a = document.getElementById('first-screen')) == null
          ? void 0
    ...
    handleKeyDown(e) {
      var _a;
      if (!this.sessionId || ((_a = this.gameState) == null ? void 0 : _a.status) !== 'playing')
        return;
      let paddle = null;
      let direction = null;
      if (e.key === 'w' || e.key === 'W') {
