...
Remarque : ces headers sont fournis par la `gateway` *après* validation du JWT. Ne faites pas confiance aux headers envoyés directement par le client — la `gateway` est l'autorité.
